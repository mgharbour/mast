...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_mast_xml_convert" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#d6c99d10#;
   pragma Export (C, u00001, "mast_xml_convertB");
   ...
   u00294 : constant Version_32 := 16#ed0ca520#;
   pragma Export (C, u00294, "mast_xml_exceptionsB");
   u00295 : constant Version_32 := 16#1632c341#;
   pragma Export (C, u00295, "mast_xml_exceptionsS");
   u00296 : constant Version_32 := 16#fedb21e8#;
   pragma Export (C, u00296, "mast_xml_parserB");
   u00297 : constant Version_32 := 16#4d2919f3#;
   pragma Export (C, u00297, "mast_xml_parserS");
   u00298 : constant Version_32 := 16#2bd88f63#;
   pragma Export (C, u00298, "domS");
   u00299 : constant Version_32 := 16#3fddfd46#;
   pragma Export (C, u00299, "dom__coreB");
   u00300 : constant Version_32 := 16#d00b2bea#;
   pragma Export (C, u00300, "dom__coreS");
   u00301 : constant Version_32 := 16#17965ec6#;
   pragma Export (C, u00301, "saxS");
   u00302 : constant Version_32 := 16#2390332a#;
   pragma Export (C, u00302, "sax__encodingsS");
   u00303 : constant Version_32 := 16#81555d43#;
   pragma Export (C, u00303, "unicodeB");
   u00304 : constant Version_32 := 16#a421878d#;
   pragma Export (C, u00304, "unicodeS");
   u00305 : constant Version_32 := 16#d4c0c09c#;
   pragma Export (C, u00305, "ada__wide_charactersS");
   u00306 : constant Version_32 := 16#7059439a#;
   pragma Export (C, u00306, "ada__wide_characters__unicodeB");
   u00307 : constant Version_32 := 16#f8f0c7fa#;
   pragma Export (C, u00307, "ada__wide_characters__unicodeS");
   ...
   u00310 : constant Version_32 := 16#5ae6f8f8#;
   pragma Export (C, u00310, "unicode__namesS");
   u00311 : constant Version_32 := 16#54c0aec0#;
   pragma Export (C, u00311, "unicode__names__basic_latinS");
   u00312 : constant Version_32 := 16#f9f0c673#;
   pragma Export (C, u00312, "unicode__cesB");
   u00313 : constant Version_32 := 16#9cb5a337#;
   pragma Export (C, u00313, "unicode__cesS");
   u00314 : constant Version_32 := 16#92f57c5b#;
   pragma Export (C, u00314, "unicode__ces__utf32B");
   u00315 : constant Version_32 := 16#b4a42d49#;
   pragma Export (C, u00315, "unicode__ces__utf32S");
   u00316 : constant Version_32 := 16#50a7378d#;
   pragma Export (C, u00316, "unicode__ccsB");
   u00317 : constant Version_32 := 16#bc6fae53#;
   pragma Export (C, u00317, "unicode__ccsS");
   u00318 : constant Version_32 := 16#5c3d1603#;
   pragma Export (C, u00318, "unicode__ces__utf8B");
   u00319 : constant Version_32 := 16#360bf12b#;
   pragma Export (C, u00319, "unicode__ces__utf8S");
   u00320 : constant Version_32 := 16#ff56a136#;
   pragma Export (C, u00320, "sax__htableB");
   u00321 : constant Version_32 := 16#ab71b2aa#;
   pragma Export (C, u00321, "sax__htableS");
   u00322 : constant Version_32 := 16#6685458a#;
   pragma Export (C, u00322, "sax__symbolsB");
   u00323 : constant Version_32 := 16#5addd918#;
   pragma Export (C, u00323, "sax__symbolsS");
   u00324 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00324, "gnatS");
   u00325 : constant Version_32 := 16#485b8267#;
   pragma Export (C, u00325, "gnat__task_lockS");
   u00326 : constant Version_32 := 16#7d808794#;
   pragma Export (C, u00326, "system__task_lockB");
   u00327 : constant Version_32 := 16#75a25c61#;
   pragma Export (C, u00327, "system__task_lockS");
   u00328 : constant Version_32 := 16#01f3c7bc#;
   pragma Export (C, u00328, "sax__pointersB");
   u00329 : constant Version_32 := 16#e04f59e9#;
   pragma Export (C, u00329, "sax__pointersS");
   u00330 : constant Version_32 := 16#675a3bbf#;
   pragma Export (C, u00330, "sax__utilsB");
   u00331 : constant Version_32 := 16#566167ac#;
   pragma Export (C, u00331, "sax__utilsS");
   u00332 : constant Version_32 := 16#d6cfcab7#;
   pragma Export (C, u00332, "dom__core__attrsB");
   u00333 : constant Version_32 := 16#699a8bfc#;
   pragma Export (C, u00333, "dom__core__attrsS");
   u00334 : constant Version_32 := 16#63f56a26#;
   pragma Export (C, u00334, "dom__core__nodesB");
   u00335 : constant Version_32 := 16#f038b144#;
   pragma Export (C, u00335, "dom__core__nodesS");
   u00336 : constant Version_32 := 16#eeeb4b65#;
   pragma Export (C, u00336, "ada__text_io__text_streamsB");
   u00337 : constant Version_32 := 16#d39d283a#;
   pragma Export (C, u00337, "ada__text_io__text_streamsS");
   u00338 : constant Version_32 := 16#514c00b3#;
   pragma Export (C, u00338, "unicode__encodingsB");
   u00339 : constant Version_32 := 16#9e1a1f3e#;
   pragma Export (C, u00339, "unicode__encodingsS");
   u00340 : constant Version_32 := 16#5f3bd63f#;
   pragma Export (C, u00340, "unicode__ccs__iso_8859_1B");
   u00341 : constant Version_32 := 16#8e38bcbd#;
   pragma Export (C, u00341, "unicode__ccs__iso_8859_1S");
   u00342 : constant Version_32 := 16#2eadc0d4#;
   pragma Export (C, u00342, "unicode__ccs__iso_8859_15B");
   u00343 : constant Version_32 := 16#92feba06#;
   pragma Export (C, u00343, "unicode__ccs__iso_8859_15S");
   u00344 : constant Version_32 := 16#f736a935#;
   pragma Export (C, u00344, "unicode__names__currency_symbolsS");
   u00345 : constant Version_32 := 16#78ee47b1#;
   pragma Export (C, u00345, "unicode__names__latin_1_supplementS");
   u00346 : constant Version_32 := 16#5cfe3178#;
   pragma Export (C, u00346, "unicode__names__latin_extended_aS");
   u00347 : constant Version_32 := 16#6fb3f27e#;
   pragma Export (C, u00347, "unicode__ccs__iso_8859_2B");
   u00348 : constant Version_32 := 16#349a01be#;
   pragma Export (C, u00348, "unicode__ccs__iso_8859_2S");
   u00349 : constant Version_32 := 16#c90d6e9f#;
   pragma Export (C, u00349, "unicode__names__spacing_modifier_lettersS");
   u00350 : constant Version_32 := 16#b43260b9#;
   pragma Export (C, u00350, "unicode__ccs__iso_8859_3B");
   u00351 : constant Version_32 := 16#487a726a#;
   pragma Export (C, u00351, "unicode__ccs__iso_8859_3S");
   u00352 : constant Version_32 := 16#3bf9b53d#;
   pragma Export (C, u00352, "unicode__ccs__iso_8859_4B");
   u00353 : constant Version_32 := 16#ad57c2bd#;
   pragma Export (C, u00353, "unicode__ccs__iso_8859_4S");
   u00354 : constant Version_32 := 16#38b356fa#;
   pragma Export (C, u00354, "unicode__ccs__windows_1251B");
   u00355 : constant Version_32 := 16#ba76c289#;
   pragma Export (C, u00355, "unicode__ccs__windows_1251S");
   u00356 : constant Version_32 := 16#f6cba099#;
   pragma Export (C, u00356, "unicode__names__cyrillicS");
   u00357 : constant Version_32 := 16#4b7938ca#;
   pragma Export (C, u00357, "unicode__names__general_punctuationS");
   u00358 : constant Version_32 := 16#c0b9df8b#;
   pragma Export (C, u00358, "unicode__names__letterlike_symbolsS");
   u00359 : constant Version_32 := 16#03991f2c#;
   pragma Export (C, u00359, "unicode__ccs__windows_1252B");
   u00360 : constant Version_32 := 16#7cee5e39#;
   pragma Export (C, u00360, "unicode__ccs__windows_1252S");
   u00361 : constant Version_32 := 16#958389e0#;
   pragma Export (C, u00361, "unicode__names__latin_extended_bS");
   u00362 : constant Version_32 := 16#f2af0fce#;
   pragma Export (C, u00362, "unicode__ces__basic_8bitB");
   u00363 : constant Version_32 := 16#78de9379#;
   pragma Export (C, u00363, "unicode__ces__basic_8bitS");
   u00364 : constant Version_32 := 16#abc6ea00#;
   pragma Export (C, u00364, "unicode__ces__utf16B");
   u00365 : constant Version_32 := 16#013c9404#;
   pragma Export (C, u00365, "unicode__ces__utf16S");
   u00366 : constant Version_32 := 16#f0a7720c#;
   pragma Export (C, u00366, "dom__core__documentsB");
   u00367 : constant Version_32 := 16#bcac667f#;
   pragma Export (C, u00367, "dom__core__documentsS");
   u00368 : constant Version_32 := 16#18cb740a#;
   pragma Export (C, u00368, "dom__core__elementsB");
   u00369 : constant Version_32 := 16#b48870c9#;
   pragma Export (C, u00369, "dom__core__elementsS");
   u00370 : constant Version_32 := 16#6189f5c2#;
   pragma Export (C, u00370, "dom__readersB");
   u00371 : constant Version_32 := 16#0c55c0b8#;
   pragma Export (C, u00371, "dom__readersS");
   u00372 : constant Version_32 := 16#0c382ace#;
   pragma Export (C, u00372, "dom__core__character_datasB");
   u00373 : constant Version_32 := 16#204a76ac#;
   pragma Export (C, u00373, "dom__core__character_datasS");
   u00374 : constant Version_32 := 16#1fe94025#;
   pragma Export (C, u00374, "sax__attributesB");
   u00375 : constant Version_32 := 16#c97e486f#;
   pragma Export (C, u00375, "sax__attributesS");
   u00376 : constant Version_32 := 16#35b5d522#;
   pragma Export (C, u00376, "sax__modelsB");
   u00377 : constant Version_32 := 16#a099163c#;
   pragma Export (C, u00377, "sax__modelsS");
   u00378 : constant Version_32 := 16#b5e7e8b9#;
   pragma Export (C, u00378, "sax__exceptionsB");
   u00379 : constant Version_32 := 16#fbc8478c#;
   pragma Export (C, u00379, "sax__exceptionsS");
   u00380 : constant Version_32 := 16#a7f1b3a1#;
   pragma Export (C, u00380, "sax__locatorsB");
   u00381 : constant Version_32 := 16#069b7760#;
   pragma Export (C, u00381, "sax__locatorsS");
   u00382 : constant Version_32 := 16#c5e7726a#;
   pragma Export (C, u00382, "gnat__directory_operationsB");
   u00383 : constant Version_32 := 16#2a2d48a6#;
   pragma Export (C, u00383, "gnat__directory_operationsS");
   u00384 : constant Version_32 := 16#1a69b526#;
   pragma Export (C, u00384, "gnat__os_libS");
   u00385 : constant Version_32 := 16#b5b32e1e#;
   pragma Export (C, u00385, "sax__readersB");
   u00386 : constant Version_32 := 16#cfb41e3d#;
   pragma Export (C, u00386, "sax__readersS");
   u00387 : constant Version_32 := 16#e4e64c07#;
   pragma Export (C, u00387, "input_sourcesB");
   u00388 : constant Version_32 := 16#15ee9c1e#;
   pragma Export (C, u00388, "input_sourcesS");
   u00389 : constant Version_32 := 16#490cc789#;
   pragma Export (C, u00389, "input_sources__fileB");
   u00390 : constant Version_32 := 16#72c9a706#;
   pragma Export (C, u00390, "input_sources__fileS");
   u00391 : constant Version_32 := 16#5e6d5972#;
   pragma Export (C, u00391, "input_sources__stringsB");
   u00392 : constant Version_32 := 16#419fcc8b#;
   pragma Export (C, u00392, "input_sources__stringsS");
   u00393 : constant Version_32 := 16#dcaddc7c#;
   pragma Export (C, u00393, "system__val_enum_16S");
   u00394 : constant Version_32 := 16#4037cf7b#;
   pragma Export (C, u00394, "system__val_enum_8S");
