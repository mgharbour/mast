...
with Mast.Processing_Resources.Processor, Mast.IO, Mast.XMI, 
  Mast.Transactions, List_Exceptions;
package body Mast.Graphs.Event_Handlers is
   ...
   begin
      if Res.Input_Link/=null then
         ...
         Ada.Text_IO.Put_Line
           (File,"Input_Event=""//@Element_List." &
         Mast.IO.Integer_Image(Mast.XMI.Get_Size_Element_List) &
         "/@Flow_Element_List." & Mast.IO.Integer_Image
         (Mast.Transactions.Find_Position
         (Mast.Graphs.Name(Res.Input_Link))) & """ ");
      end if;
      if Res.Output_Link/= null then
         Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation));
         Ada.Text_IO.Put_Line
           (File,"Output_Event=""//@Element_List." &
         Mast.IO.Integer_Image(Mast.XMI.Get_Size_Element_List) &
         "/@Flow_Element_List." & Mast.IO.Integer_Image
         (Mast.Transactions.Find_Position
         (Mast.Graphs.Name(Res.Output_Link))) & """");
      end if;
   end Print_XMI;
   ...
   begin
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation));
      Ada.Text_IO.Put_Line(File,"<Flow_Element_List");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:Step""");
      Print_XMI(File,Simple_Event_Handler(Res),Indentation+4,False);
      if Res.Activity_Operation /= null then
         Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
         Ada.Text_IO.Put
           (File,"Step_Operation= """ &
         XMI.XMI_Name_Image
         (Mast.Operations.Name(Res.Activity_Operation),
         "op_") &
            """");
      end if;
      if Res.Activity_Server /= null then
         ...
         if Res.Activity_Server.Server_Processing_Resource.all in 
      Processing_Resources.Processor.Processor'class
    then
            Ada.Text_IO.Put
         (File,"Step_Schedulable_Resource= """ &
       XMI.XMI_Name_Image
       (Mast.Scheduling_Servers.Name (Res.Activity_Server), "th_") &
       """");
         else
            Ada.Text_IO.Put
         (File,"Step_Schedulable_Resource= """ &
       XMI.XMI_Name_Image
       (Mast.Scheduling_Servers.Name (Res.Activity_Server), "com_") &
       """");      
         end if;
      end if;
      Ada.Text_IO.Put_Line(File,"/>");
   ...
   begin
      ...
      (File,"Step_Operation= """ &
         XMI.XMI_Name_Image
         (Mast.Operations.Name(Res.Activity_Operation), "op_") &
         """");
      end if;
      if Res.Activity_Server /= null then
         Ada.Text_IO.New_Line(File);
   ...
   begin
      ...
      if Link_Lists.Size(Res.Input_Links)>0 then
         Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation));
         Ada.Text_IO.Put(File,"Input_Event_List=""/");
         Link_Lists.Rewind(Res.Input_Links,Iterator);
         for I in 1..Link_Lists.Size(Res.Input_Links) loop
            Link_Lists.Get_Next_Item(Res_Ref,Res.Input_Links,Iterator);
            Ada.Text_IO.Put
   ...
   begin
      ...
      Ada.Text_IO.Put_Line(File, "<Flow_Element_List");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:Merge""");
      Print_XMI(File,Input_Event_Handler(Res),Indentation+4,False);
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"/>");
   end Print_XMI;
   ...
   begin
      ...
      Ada.Text_IO.Put_Line(File, "<Flow_Element_List");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:Join""");
      Print_XMI(File,Input_Event_Handler(Res),Indentation+4,False);
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"/>");
   end Print_XMI;
   ...
   begin
      ...
      if Link_Lists.Size(Res.Output_Links)>0 then
         Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation));
         Ada.Text_IO.Put(File,"Output_Event_List=""/");
         Link_Lists.Rewind(Res.Output_Links,Iterator);
         for I in 1..Link_Lists.Size(Res.Output_Links) loop
            Link_Lists.Get_Next_Item(Res_Ref,Res.Output_Links,Iterator);
            Ada.Text_IO.Put
   ...
   begin
      ...
      Ada.Text_IO.Put_Line(File, "<Flow_Element_List");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:Branch""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
   (File,"Delivery_Policy=""" & 
      IO.XML_Enum_Image(Delivery_Policy'Image(Res.Policy)) & """");
      Print_XMI(File,Output_Event_Handler(Res),Indentation+4,False);
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"/>");
   end Print_XMI;
   ...
   begin
      ...
      Ada.Text_IO.Put_Line(File, "<Flow_Element_List");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:Queried_Branch""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
   (File,"Delivery_Policy=""" & 
      IO.XML_Enum_Image(Request_Policy'Image(Res.Policy)) & """");
   ...
   begin
      ...
      Ada.Text_IO.Put_Line(File, "<Flow_Element_List");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:Fork""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Print_XMI(File,Output_Event_Handler(Res),Indentation,False);
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"/>");
   end Print_XMI;
   ...
   begin
      ...
      Ada.Text_IO.Put_Line(File, "<Flow_Element_List");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:Rate_Divisor""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
        (File,"Rate_Factor=""" & IO.Integer_Image(Res.Rate_Factor) & """");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Print_XMI(File,Simple_Event_Handler(Res),Indentation,False);
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"/>");
   end Print_XMI;
   ...
   begin
      ...
      Ada.Text_IO.Put_Line(File, "<Flow_Element_List");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:Delay""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
        (File,"Delay_Max_Interval=""" &
         IO.Time_Image(Res.Delay_Max_Interval) & """");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
        (File,"Delay_Avg_Interval=""" &
      IO.Time_Image((Res.Delay_Max_Interval+Res.Delay_Min_Interval)/2.0) &
      """");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
        (File,"Delay_Min_Interval=""" &
   ...
   begin
      ...
      Ada.Text_IO.Put_Line(File, "<Flow_Element_List");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:Offset""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));      
      Ada.Text_IO.Put_Line
        (File,"Delay_Max_Interval=""" &
      ...
      if Res.Referenced_Event/=null then
         ...
         (Mast.Transactions.Find_Position
       (Mast.Events.Name(Res.Referenced_Event))) & """");
      end if;
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"/>");
   end Print_XMI;
   ...
   overriding procedure Remove_Link_From_Handler
