...
with Mast.IO, Mast.XMI, List_Exceptions;
package body Mast.Operations is

   use type Results.Slack_Result_Ref;
   pragma Warnings (Off, "use clause for type * defined at mast-scheduling_parameters.ads:57 has no effect", Reason => "TBD");
   use type Mast.Scheduling_Parameters.Sched_Parameters_Ref;
   pragma Warnings (On, "use clause for type * defined at mast-scheduling_parameters.ads:57 has no effect");
   ...
   procedure Adjust
     (The_List : Lists.List;
      Res_List : Shared_Resources.Lists.List)
   is
   ...
   overriding function Avg_Case_Execution_Time
     (Op : Simple_Operation;
   ...
   overriding function Best_Case_Execution_Time
     (Op : Simple_Operation;
      Throughput : Throughput_Value)
     return Normalized_Execution_Time
   is
   ...
   begin
      if Complete then
         ...
         Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:Simple_Operation""");
      end if;
      Ada.Text_IO.Set_Col(File,Indent+4);
      Ada.Text_IO.Put_Line(File,"name=""" & 
              XMI.XMI_Name_Image(Res.Name, "op_") & """");
      Ada.Text_IO.Set_Col(File,Indent+4);
      Ada.Text_IO.Put_Line(File,"Worst_Case_Execution_Time=""" &
                      IO.Execution_Time_Image(Res.Worst_Case_Execution_Time*
                                              Res.Scale_Factor) & """");
      Ada.Text_IO.Set_Col(File,Indent+4);
      Ada.Text_IO.Put_Line(File,"Avg_Case_Execution_Time=""" &
                      IO.Execution_Time_Image(Res.Avg_Case_Execution_Time*
                                              Res.Scale_Factor) & """ ");
      Ada.Text_IO.Set_Col(File,Indent+4);
      Ada.Text_IO.Put
        (File,"Best_Case_Execution_Time=""" &
         IO.Execution_Time_Image(Res.Best_Case_Execution_Time*
               Res.Scale_Factor) & """");
      Has_Overridden := Res.New_Sched_Parameters /= null;
      if Shared_Resources_List.Size(Res.Locked_Shared_Resources)>0 then
         Ada.Text_IO.New_Line(File);
         Ada.Text_IO.Set_Col(File,Indent+4);
         Ada.Text_IO.Put(File,"Mutex_To_Lock_List=""");
         Shared_Resources_List.Rewind(Res.Locked_Shared_Resources,Iterator);
         for I in 1..Shared_Resources_List.Size
           (Res.Locked_Shared_Resources)
         loop
            Shared_Resources_List.Get_Next_Item
              (Res_Ref,Res.Locked_Shared_Resources,Iterator);
            Ada.Text_IO.Put(File,XMI.XMI_Name_Image
                            (Mast.Shared_Resources.Name(Res_Ref), "sh_"));
            if I/=Shared_Resources_List.Size(Res.Locked_Shared_Resources)
            then
               Ada.Text_IO.Put(File," ");
            end if;
      ...
      then
         Ada.Text_IO.New_Line(File);
         Ada.Text_IO.Set_Col(File,Indent+4);
         Ada.Text_IO.Put(File,"Mutex_To_Unlock_List=""");
         Shared_Resources_List.Rewind(Res.Unlocked_Shared_Resources,Iterator);
         for I in 1..Shared_Resources_List.Size
           (Res.Unlocked_Shared_Resources)
         loop
      ...
      if Complete and then Has_Overridden then
         Ada.Text_IO.Set_Col(File,Indent);
         Ada.Text_IO.Put_Line(File,"</Element_List>");
      end if;
   end Print_XMI;
   ...
   begin
      ...
      Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:Composite_Operation""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"name=""" & 
              XMI.XMI_Name_Image(Res.Name, "op_") & """");
      Has_Overridden := Res.New_Sched_Parameters /= null;
      ...
      if Op_Lists.Size(Res.Op_List) > 0 then
         ...
         Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
         Ada.Text_IO.Put(File,"Operation_List=""");
         Op_Lists.Rewind(Res.Op_List,Iterator);
         for I in 1..Op_Lists.Size(Res.Op_List) loop
            Op_Lists.Get_Next_Item(Res_Ref,Res.Op_List,Iterator);
            Ada.Text_IO.Put(File,XMI.XMI_Name_Image
                            (Mast.Operations.Name(Res_Ref), "op_"));
            if I/=Op_Lists.Size(Res.Op_List)
            then
               Ada.Text_IO.Put(File," ");
            end if;
   ...
   begin
      ...
      Ada.Text_IO.Put_Line(File,"<Element_List");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:Enclosing_Operation""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"name=""" & 
              XMI.XMI_Name_Image(Res.Name, "op_") & """");
      Has_Overridden := Res.New_Sched_Parameters /= null;
   ...
   begin
      ...
      Ada.Text_IO.Put_Line(File,"<Element_List");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:Message""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"name=""" & 
              XMI.XMI_Name_Image(Res.Name, "op_") & """");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"Max_Message_Size=""" &
              IO.Int_Bit_Count_Image
              (Res.Max_Message_Size*
            Bit_Count(Res.Scale_Factor)) & """");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"Avg_Message_Size=""" &
              IO.Int_Bit_Count_Image
              (Res.Avg_Message_Size*
            Bit_Count(Res.Scale_Factor)) & """ ");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
   ...
   begin
      ...
      if Op.The_Slack_Result/=null then
         ...
         Ada.Text_IO.Put_Line(File,"<mast_res:Operation Name="""&
                              XMI.XMI_Name_Image(Op.Name, "op_")&""">");
   ...
   begin
      ...
      for I in 1..Lists.Size(The_List) loop
         Lists.Get_Next_Item(Op_Ref,The_List,Iterator);
         Print_XMI_Results(File,Op_Ref.all,Indentation,True);
      end loop;
   end Print_XMI_Results;
   ...
   procedure Relative_Scale
     (The_List : Lists.List; Factor : Normalized_Execution_Time)
   is
      Iterator : Lists.Iteration_Object;
      Op_Ref : Operation_Ref;
   begin
   ...
   overriding procedure Relative_Scale
   ...
   overriding function Shared_Resources_Used
     (Op : Simple_Operation)
     return Boolean
   is
   begin
   ...
   overriding function Operation_References_Shared_Resource
     (Op     : Simple_Operation;
      Sr_Ref : Shared_Resources.Shared_Resource_Ref)
     return Boolean
   is
   ...
   begin
      ...
      for I in 1..Op_Lists.Size(Op.Op_List) loop
         Op_Lists.Get_Next_Item(Op_Ref,Op.Op_List,Iterator);
         Used := Used or else Shared_Resources_Used(Op_Ref.all);
      end loop;
      return Used;
   end Shared_Resources_Used;
   ...
   overriding function Worst_Case_Execution_Time
     (Op : Simple_Operation;
      Throughput : Throughput_Value)
     return Normalized_Execution_Time
   is
