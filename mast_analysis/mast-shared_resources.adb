...
package body Mast.Shared_Resources is
   ...
   is
      -- Names_Length : constant := 8;
      First_Item : Boolean:=True;
      pragma Unreferenced (First_Item);
   begin
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation));
   ...
   begin
      ...
      Ada.Text_IO.Put_Line
   (File,"xsi:type=""mast2:Priority_Inheritance_Mutex""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"name=""" & 
              XMI.XMI_Name_Image(Res.Name, "sh_") & """/>");
   end Print_XMI;
   ...
   begin
      ...
      Ada.Text_IO.Put_Line(File, "<Element_List");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:Immediate_Ceiling_Mutex""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"name=""" & 
              XMI.XMI_Name_Image(Res.Name, "sh_") & """ ");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"Ceiling=""" & IO.Priority_Image(Res.Ceiling) &
              """");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
        (File,"Preassigned=""" &
   ...
   begin
      ...
      Ada.Text_IO.Put_Line(File, "<Element_List");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"xsi:type=""mast2:SRP_Mutex""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"name=""" & 
              XMI.XMI_Name_Image(Res.Name, "sh_") & """");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
   ...
   begin
      ...
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
   (File,"xsi:type=""mast2_res:Priority_Inheritance_Mutex_Result""");
      if Res.The_Queue_Size_Result/=null then
         Results.Print_XMI(File,Res.The_Queue_Size_Result.all,Indentation+4);
      end if;
      if Res.The_Preemption_Level_Result/=null then
         Results.Print_XMI
      (File,Res.The_Preemption_Level_Result.all,Indentation+4);
      end if;
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+2));
      Ada.Text_IO.Put_Line(File, ">");
      
      if Res.The_Utilization_Result/=null then
         Results.Print_XMI(File, Res.The_Utilization_Result.all,Indentation+4);
      end if;
      if Res.The_Ceiling_Result/=null then
         Results.Print_XMI(File,Res.The_Ceiling_Result.all,Indentation+4);
      end if;
   ...
   (File,"xsi:type=""mast2_res:Immediate_Ceiling_Mutex_Result""");
      ...
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+6));
      Ada.Text_IO.Put_Line
   (File,"xsi:type=""mast2:Immediate_Ceiling_Mutex""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+6));
      Ada.Text_IO.Put_Line(File,"href=""" & 
              To_String(Mast.XMI.Get_XMI_Model_File) & "#" &
              XMI.XMI_Name_Image(Res.Name, "sh_") & """/>");
   ...
   begin
      ...
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
   (File,"xsi:type=""mast2_res:SRP_Mutex_Result""");
      if Res.The_Queue_Size_Result/=null then
         Results.Print_XMI(File,Res.The_Queue_Size_Result.all,Indentation+4);
         First_Item:=False;
      end if;
