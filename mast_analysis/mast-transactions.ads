...
package Mast.Transactions is
   ...
   function Find_Position(Event_Name: Var_String) return Natural;
   ...
   function Cumulative_Rate_Factor
     (Trans : Transaction)
     return Positive;
   -- Return the cumulative rate factor of the transaction,
   -- obtained by multiplying the rate factors of rate divisors in the
   -- transaction; returns 1 if there are no rate divisors
