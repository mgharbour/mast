...
with Mast.Transactions, Mast.IO, Mast.XMI, Var_Strings;
use Var_Strings;
...
package body Mast.Events is
   ...
   begin
      ...
      Ada.Text_IO.Put_Line
        (File,"xsi:type=""mast2:Internal_Event""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put
   (File, "name=""" & 
      XMI.XMI_Name_Image
   ...
   begin
      ...
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
        (File,"xsi:type=""mast2:Periodic_Event""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
   (File, "name=""" & 
      XMI.XMI_Name_Image
      ...
      """");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line(File,"Period=""" & 
              IO.Time_Image(Evnt.Period) & """");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
        (File,"Max_Jitter=""" & IO.Time_Image(Evnt.Max_Jitter) & """");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
   ...
   begin
      ...
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
        (File,"xsi:type=""mast2:Singular_Event""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
   (File, "name=""" &
      XMI.XMI_Name_Image
   ...
   begin
      ...
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
        (File,"xsi:type=""mast2:Sporadic_Event""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
   (File, "name=""" &
      XMI.XMI_Name_Image
   ...
   begin
      ...
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
        (File,"xsi:type=""mast2:Unbounded_Event""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
   (File, "name=""" &
      XMI.XMI_Name_Image
   ...
   begin
      ...
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
        (File,"xsi:type=""mast2:Bursty_Event""");
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation+4));
      Ada.Text_IO.Put_Line
   (File, "name=""" &
      XMI.XMI_Name_Image
