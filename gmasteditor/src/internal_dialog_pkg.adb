...
package body Internal_Dialog_Pkg is
   ...
   procedure Gtk_New 
     (Internal_Dialog : out Internal_Dialog_Access;
      Parent : Gtk.Window.Gtk_Window) is
   begin
      Internal_Dialog := new Internal_Dialog_Record;
      Internal_Dialog_Pkg.Initialize (Internal_Dialog, Parent);
   end Gtk_New;

   procedure Initialize
     (Internal_Dialog : access Internal_Dialog_Record'Class) is
   begin
      Initialize
	(Internal_Dialog, 
   ...
   begin
      ...
      --  Set_Modal (Internal_Dialog, True);
      Gtk.Dialog.Initialize 
	(Dialog => Internal_Dialog,
	 Title => "Internal Event Parameters",
	 Parent => Parent,
	 Flags => Gtk.Dialog.Modal);                
      ...
      Pack_Start
        (Get_Content_Area (Internal_Dialog),
      ...
      -----------------------------------------------
      Set_Size_Request (Internal_Dialog.Frame, 695, 250);
      ...
      Internal_Dialog.Num :=
        Append_Column (Internal_Dialog.Tree_View, Internal_Dialog.Col);
      Set_Min_Width (Internal_Dialog.Col, 100);
      Pack_Start
        (Internal_Dialog.Col,
