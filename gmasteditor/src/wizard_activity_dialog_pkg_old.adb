...
package body Wizard_Activity_Dialog_Pkg is
   ...
   begin
      ...
      Set_Title (Wizard_Activity_Dialog, -"Editor Wizard Tool - Step 3");
      Set_Position (Wizard_Activity_Dialog, Win_Pos_None);
      ...
      Gtk_New (Wizard_Activity_Dialog.Serv_Table, 2, 2, True);
