...
package body Seh_Dialog_Pkg is
   ...
   begin
      Seh_Dialog := new Seh_Dialog_Record;
      Seh_Dialog_Pkg.Initialize (Seh_Dialog, Parent);
   end Gtk_New;
   
   procedure Initialize 
     (Seh_Dialog : access Seh_Dialog_Record'Class) is
   begin
      Initialize
	(Seh_Dialog, 
   ...
   begin
      ...
      loop
         ...
         String_List.Append (Ser_Combo_Items, To_String (Ser_Name));
      end loop;
	...
	(Dialog => Seh_Dialog,
	 ...
	 Flags => Gtk.Dialog.Modal);                
      ...
      Utilities.Set_Popdown_Strings (Seh_Dialog.Op_Combo, Op_Combo_Items);
      ...
      Utilities.Set_Popdown_Strings (Seh_Dialog.Ser_Combo, Ser_Combo_Items);
