...
package body Add_New_Server_To_Driver_Dialog_Pkg is
   ...
   begin
      Add_New_Server_To_Driver_Dialog :=
        new Add_New_Server_To_Driver_Dialog_Record;
      Add_New_Server_To_Driver_Dialog_Pkg.Initialize
        (Add_New_Server_To_Driver_Dialog, Parent);
   end Gtk_New;
   ...
   begin
	...
	(Dialog => Add_New_Server_To_Driver_Dialog,
	 Title => -"Adding Driver's Servers",
	 Parent => Parent,
	 Flags => Gtk.Dialog.Modal);    
      ...
      Attach
        (Add_New_Server_To_Driver_Dialog.Table1,
         ...
         Ypadding      => 0);
      Pack_Start
        (Get_Content_Area (Add_New_Server_To_Driver_Dialog),
         Add_New_Server_To_Driver_Dialog.Table1,
         Expand  => True,
         Fill    => False,
         Padding => 0);
