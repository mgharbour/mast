...
package body Wizard_Input_Dialog_Pkg is
   ...
   begin
	...
	(Dialog => Wizard_Input_Dialog,
	 Title => -"Editor Wizard Tool - Step 2 of 4",
	 ...
	 Flags => Gtk.Dialog.Modal);                
      ...
      Pack_Start
        (Get_Content_Area (Wizard_Input_Dialog),
         Wizard_Input_Dialog.Table3,
         Expand  => True,
         Fill    => True,
         Padding => 0);

      Wizard_Input_Dialog.Pixbuf1 := Gdk.Pixbuf.Gdk_New_From_XPM_Data
	(Mast_Analysis_Pixmaps.Mast_Logo_Xpm);
      Wizard_Input_Dialog.Image:=
	Gtk_Image_New_From_Pixbuf(Wizard_Input_Dialog.Pixbuf1);
      ...
      Gtk_New (Wizard_Input_Dialog.Label548, -("Phase (time)"));
      ...
      Gtk_New (Wizard_Input_Dialog.Label549, 
	       -("Maximum Jitter (time)"));
      ...
      Gtk_New (Wizard_Input_Dialog.Label550, -("Period (time)"));
      ...
      Gtk_New (Wizard_Input_Dialog.Label551, -("Phase (time)"));
      ...
      Gtk_New (Wizard_Input_Dialog.Label552, 
      ...
      Gtk_New (Wizard_Input_Dialog.Label553, 
      ...
      Gtk_New (Wizard_Input_Dialog.Label554, 
      ...
      Gtk_New (Wizard_Input_Dialog.Label555, 
	       -("Avg Interarrival Time"));
      ...
      Gtk_New (Wizard_Input_Dialog.Label556, 
	       -("Distribution Function"));
      ...
      Gtk_New (Wizard_Input_Dialog.Label558, 
	       -("Distribution Function"));
      ...
      Gtk_New (Wizard_Input_Dialog.Label559, 
	       -("Avg Interarrival Time"));
