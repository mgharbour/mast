...
package body Second_Sched_Dialog_Pkg.Callbacks is
   ...
   procedure On_Policy_Type_Entry_Changed
     (Object : access Second_Sched_Dialog_Record'Class)
   is
      Policy_Type : String :=
   ...
   begin
      ...
      Object.Resize(200,150);
   end On_Policy_Type_Entry_Changed;

end Second_Sched_Dialog_Pkg.Callbacks;
