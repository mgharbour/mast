...
package External_Dialog_Pkg is
   ...
   type External_Dialog_Record is new Gtk_Dialog_Record with record
      ...
      External_Event_Type_Combo : Gtk_Combo_Box_Text;
      ...
      Spo_Dist_Func_Combo       : Gtk_Combo_Box_Text;
      Label227                  : Gtk_Label;
      Unbounded_Table           : Gtk_Table;
      Unb_Avg_Entry             : Gtk_Entry;
      Label237                  : Gtk_Label;
      Unb_Dist_Func_Combo       : Gtk_Combo_Box_Text;
      Label238                  : Gtk_Label;
      ...
      Bur_Dist_Func_Combo       : Gtk_Combo_Box_Text;
      Label241                  : Gtk_Label;
      Label242                  : Gtk_Label;
