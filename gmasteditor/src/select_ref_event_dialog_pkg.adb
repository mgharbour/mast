...
package body Select_Ref_Event_Dialog_Pkg is
   ...
   begin
      Select_Ref_Event_Dialog := new Select_Ref_Event_Dialog_Record;
      Select_Ref_Event_Dialog_Pkg.Initialize (Select_Ref_Event_Dialog, Parent);
   end Gtk_New;
   ...
   begin
	...
	(Dialog => Select_Ref_Event_Dialog,
	 Title => -"Select Referenced Event ...",
	 Parent => Parent,
	 Flags => Gtk.Dialog.Modal);                
      ...
      Pack_Start
        (Get_Content_Area (Select_Ref_Event_Dialog),
      ...
      Set_Text_In_Combo_Box (Select_Ref_Event_Dialog.Ref_Event_Combo, -(""));
