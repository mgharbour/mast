...
package Save_File_Selection_Pkg is
   ...
   type Save_File_Selection_Record is new Gtk_File_Chooser_Dialog_Record with
      record
   ...
   type Save_File_Selection_Access is access all 
     Save_File_Selection_Record'Class;
