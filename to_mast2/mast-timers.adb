...
package body Mast.Timers is
   ...
   begin
      ...
      Ada.Text_IO.Put(File,"Timing_Object (");
   end Print;
   ...
   begin
      Print(File,System_Timer(Timer),Name,Indentation);
      MAST.IO.Print_Arg
        (File,"Type",
         "Alarm_Clock",Indentation+3,Names_Length);
      MAST.IO.Print_Separator(File);
      MAST.IO.Print_Arg
        (File,"Name",Name,Indentation+3,Names_Length);
      MAST.IO.Print_Separator(File);
      MAST.IO.Print_Arg
        (File,"Worst_Overhead",
         IO.Execution_Time_Image
         (Timer.Worst_Overhead),Indentation+3,Names_Length);
      MAST.IO.Print_Separator(File);
      MAST.IO.Print_Arg
        (File,"Avg_Overhead",
         IO.Execution_Time_Image
         (Timer.Avg_Overhead),Indentation+3,Names_Length);
      MAST.IO.Print_Separator(File);
      MAST.IO.Print_Arg
        (File,"Best_Overhead",
         IO.Execution_Time_Image
         (Timer.Best_Overhead),Indentation+3,Names_Length);
   ...
   begin
      ...
      MAST.IO.Print_Arg
        (File,"Type",
         "Ticker",Indentation+3,Names_Length);
      MAST.IO.Print_Separator(File);
      MAST.IO.Print_Arg
        (File,"Name",Name,Indentation+3,Names_Length);
      MAST.IO.Print_Separator(File);
      ...
      MAST.IO.Print_Arg
        (File,"Period",
         IO.Time_Image(Timer.Period),Indentation+3,Names_Length);
      MAST.IO.Print_Separator(File,",",True);
   end Print;
   ...
   begin
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation));
      Ada.Text_IO.Put(File,"<mast_mdl:Alarm_Clock Name="""&
         Name & """ ");
      Ada.Text_IO.Put
        (File," Max_Overhead=" & """" &
   ...
   begin
      Ada.Text_IO.Set_Col(File,Ada.Text_IO.Count(Indentation));
      Ada.Text_IO.Put(File,"<mast_mdl:Ticker Name="""&
         Name & """ ");
      Ada.Text_IO.Put
        (File," Max_Overhead=" & """" &
         IO.Execution_Time_Image(Timer.Worst_Overhead) & """");
